...
public final class BossMobPositioner {
     ...
     */
    public static List<BlockPos> findBasketGuardPositions(ServerWorld world, Random random, BlockPos basketPos, int count) {
     ...
     */
    public static List<BlockPos> findFairwayPatrolPositions(ServerWorld world, Random random, BlockPos teePos, BlockPos basketPos, int count) {
        List<BlockPos> positions = new ArrayList<>();
        int attempts = 20;
     ...
     */
    public static List<BlockPos> findTeeHarassPositions(ServerWorld world, Random random, BlockPos teePos, int count) {
        List<BlockPos> positions = new ArrayList<>();
        int attempts = 15;
    ...
    private static boolean isValidSpawn(ServerWorld world, BlockPos feet) {
        ...
        // Avoid spawning in fluids (water, lava, etc.)
        if (!world.getFluidState(feet).isEmpty() || !world.getFluidState(head).isEmpty() || !world.getFluidState(ground).isEmpty()) {
            return false;
        }
